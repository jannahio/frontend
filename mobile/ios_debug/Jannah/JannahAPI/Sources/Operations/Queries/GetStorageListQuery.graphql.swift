...
public class GetStorageListQuery: GraphQLQuery {
  public static let operationName: String = "getStorageList"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query getStorageList { allStorages { __typename id name slug description } }"#
    ))
